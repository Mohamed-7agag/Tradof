            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  verticalSpace(4),
                  Text('${projectModel.days} Days', style: AppStyle.robotoCondensedMedium12),
                ],
              ),
              Column(
                children: [
                  ...
                  verticalSpace(4),
                  Text('${projectModel.minPrice} - ${projectModel.maxPrice}\$', style: AppStyle.robotoCondensedMedium12),
                ],
              ),
            ],
          ),
