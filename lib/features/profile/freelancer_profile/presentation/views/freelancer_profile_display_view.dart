            ...
            return Column(
              children: [
                ProfileAppBar(
                  ...
                  userName:
                      '${state.freelancerModel!.firstName} ${state.freelancerModel!.lastName}',
                  email: state.freelancerModel!.email,
                  extra: state.freelancerModel!.countryName,
                  userImageUrl: state.freelancerModel!.profileImageUrl,
                  isCompany: false,
                ),
                Expanded(
