...
class _NotificationSettingSectionState
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<MiscellaneousCubit, MiscellaneousState>(
      ...
      builder: (context, state) => state.status.isGetNotificationSettingLoading
          ? Container(
              height: 200,
                ...
                children: [
                  NotificationSettingSwitcherItem(
                    value: optionOneValue ??
                        state.notificationSettingModel?.sendEmail == 1,
                  ...
                  NotificationSettingSwitcherItem(
                    value: optionTwoValue ??
                        state.notificationSettingModel?.alertOffers == 1,
                    title: 'Offer status alerts',
                    subTitle:
                        'Get notified about offer approvals or rejections',
                    onChanged: (value) {
                      setState(() {
                  ...
                  NotificationSettingSwitcherItem(
                    value: optionThreeValue ??
                        state.notificationSettingModel?.messageChat == 1,
