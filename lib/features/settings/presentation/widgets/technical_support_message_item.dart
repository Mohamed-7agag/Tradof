...
class TechnicalSupportMessageItem extends StatelessWidget {
  const TechnicalSupportMessageItem({required this.message, super.key});
  final TechnicalSupportMessageModel message;
